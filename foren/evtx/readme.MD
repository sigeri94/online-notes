...
| Log Source                               | Event ID | Deskripsi          | Nilai Forensik  |
| ---------------------------------------- | -------- | ------------------ | --------------- |
| TerminalServices-LocalSessionManager     | 21       | RDP session logon  | Remote login    |
| TerminalServices-RemoteConnectionManager | 1149     | RDP authentication | RDP brute force |
