...
# Oracle Database 19c – Setup & Lab SAWITDB (Windows)
...
DATAFILE 'D:\ORADATA\SAWITDB\users01.dbf'
SIZE 200M
...
```sql
CREATE USER SAWIT_LAB IDENTIFIED BY sawit123
DEFAULT TABLESPACE USERS
TEMPORARY TABLESPACE TEMP
QUOTA UNLIMITED ON USERS;

GRANT CONNECT, RESOURCE TO SAWIT_LAB;
```
